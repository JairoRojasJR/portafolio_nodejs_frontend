    ...
    <nav className='df aifs jcc'>
      <Button
        ...
        <Content
          ...
          <Card src='/images/html_css_js-profesor_dalto.png'>
            <p>
          ...
          <Card src='/images/php-profesor_oscar.png'>
            <p>
          ...
          <Card src='/images/sql_git-profesor_nicolas.png'>
            <p>
          ...
          <Card src='/images/react_nodejs-profesora_estefania.png'>
            <p>
